...
# HTML Changes
    ...
    - changed the <div class="footer"> to the <footer> semantic element
...
# CSS Changes
    ...
    - Greatly Reduced amount of CSS by reworking the Class + IDs in HTML, and deleted redundant code
